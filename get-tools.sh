...
linux_scripts() {
    ...
    wget -q --show-progress https://raw.githubusercontent.com/urbanadventurer/username-anarchy/refs/heads/master/username-anarchy && chmod +x username-anarchy && ln -s $DIR/linux-scripts/username-anarchy /usr/local/bin/username-anarchy
