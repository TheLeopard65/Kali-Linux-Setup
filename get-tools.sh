...
linux_scripts() {
    ...
    wget -q --show-progress https://raw.githubusercontent.com/enjoiz/XXEinjector/refs/heads/master/XXEinjector.rb && chmod +x XXEinjector.rb && ln -s {$DIR}/XXEinjector.rb /usr/local/bin/XXEinjector
    ...
    wget -q --show-progress https://raw.githubusercontent.com/urbanadventurer/username-anarchy/refs/heads/master/username-anarchy && chmod +x username-anarchy && ln -s {$DIR}/username-anarchy /usr/local/bin/username-anarchy
    ...
    wget -q --show-progress https://github.com/assetnote/kiterunner/releases/download/v1.0.2/kiterunner_1.0.2_linux_amd64.tar.gz -O kiterunner-1.0.2.tar.gz && tar -xzf kiterunner-1.0.2.tar.gz && ln -s {$DIR}/kr /usr/local/bin/kr && rm kiterunner-1.0.2.tar.gz
    ...
    wget -q --show-progress https://github.com/ropnop/kerbrute/releases/download/v1.0.3/kerbrute_linux_amd64 -O kerbrute && chmod +x ./kerbrute && ln -s {$DIR}/kerbrute /usr/local/bin/kerbrute
