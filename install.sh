...
info "[##] Installing Language & Support Tools ---------------- [ TOTAL = 15 ]"
...
info "[##] Installing Miscellaneous Tools --------------------- [ TOTAL = 18 ]"
...
autopsy powershell-empire xxd jq
...
xsser burpsuite beef zaproxy shellfire
...
if [[ "$pipt" == "y" ]]; then
	info "[##] Installing Important PIPX Tools -------------------- [ TOOLS = 16 ]"
	...
	pipx install --quiet defaultcreds-cheat-sheet kerbrute pywhisker> /dev/null
